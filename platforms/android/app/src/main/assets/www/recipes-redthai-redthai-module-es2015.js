...
let RedthaiPageModule = class RedthaiPageModule {
};
...
let RedthaiPage = class RedthaiPage {
    constructor(router) {
        this.router = router;
    }
};
RedthaiPage.ctorParameters = () => [
...
//# sourceMappingURL=recipes-redthai-redthai-module-es2015.js.map