...
const Button = class {
    constructor(hostRef) {
        ...
        this.handleClick = (ev) => {
            ...
            else if (Object(_helpers_e0fdb9d0_js__WEBPACK_IMPORTED_MODULE_2__["h"])(this.el)) {
...
const Icon = class {
    ...
    render() {
        ...
        return (Object(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_57385ee8_js__WEBPACK_IMPORTED_MODULE_0__["H"], { role: "img", class: Object.assign({ [mode]: true }, createColorClasses(this.color), { [`icon-${this.size}`]: !!this.size, 'flip-rtl': !!flipRtl && this.el.ownerDocument.dir === 'rtl' }) }, (( this.svgContent)
